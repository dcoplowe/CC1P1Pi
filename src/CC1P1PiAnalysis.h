...
private:
    ...
    TVector3 * GetTransverseVars(double vtx[3], const TVector3 *& mumom, const TVector3 *& prmom, const TVector3 *& pimom, double dpTT, double dpTMag, double dalphaT, double dphiT, bool is_truth) const;
