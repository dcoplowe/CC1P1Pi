...
#include "TemplateAnalysisTool.h"
...
DECLARE_TOOL_FACTORY( TemplateAnalysisTool );


//! Standard constructor, initializes variables
/*
   Call the constructor to MinervaAnalsysisTool.
 */
TemplateAnalysisTool::TemplateAnalysisTool(const std::string& type, const std::string& name, const IInterface* parent ) : MinervaAnalysisTool( type, name, parent ) 
{
   ...
   */
  m_hypMeths.push_back( "InterpretationA" );
...
//! Initialize
StatusCode TemplateAnalysisTool::initialize()
{
  info() << "DAVID: TemplateAnalysisTool::initialize()" << endmsg;
 ...
 */
StatusCode TemplateAnalysisTool::reconstructEvent( Minerva::PhysicsEvent *event, Minerva::GenMinInteraction* truth /* = NULL */ ) const
{
  debug() << "TemplateAnalysisTool::reconstructEvent( PhysicsEvent *event, GenMinInteraction* truth )" << endmsg;
 ...
 */
StatusCode TemplateAnalysisTool::interpretEvent( const Minerva::PhysicsEvent *event, const Minerva::GenMinInteraction *interaction, std::vector<Minerva::NeutrinoInt*>& nuInts ) const
{
  debug() << "TemplateAnalysisTool::interpretEvent( const PhysicsEvent*, const GenMinInteraction*, std::vector<NeutrinoInt*>& )const" << endmsg;
...
StatusCode TemplateAnalysisTool::tagTruth( Minerva::GenMinInteraction *truth ) const
{
...
//! Finalize
StatusCode TemplateAnalysisTool::finalize()
{
  debug() << "TemplateAnalysisTool::finalize()" << endmsg;
...
bool TemplateAnalysisTool::truthIsPlausible( const Minerva::PhysicsEvent * event ) const
{
